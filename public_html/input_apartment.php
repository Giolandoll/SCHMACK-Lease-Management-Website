<?php include 'fetch_leasedata.php'; // Include the PHP file to fetch lease options ?>
...
<header>
    ...
    <section class="entity-input">
        <h2>Input Apartment</h2>
        <form action="submit_apartment.php" method="POST">
